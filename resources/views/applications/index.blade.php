...
@if(auth()->user()->isAdmin() or auth()->user()->id == $application->user_id)
    ...
    @if(URL::current() !== route('archived-applications.index')) 
        <a href="{{ route('application.show', $application->api_token) }}" class="applications-open px-2" alt="View application" title="View Application"><svg xmlns="http://www.w3.org/2000/svg" class="bi bi-file-earmark-plus-fill" viewBox="0 0 16 16" width="24" height="24" fill="#0dcaf0">
