...
<form class="application-form" action="{{ route('applicants.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
@csrf

<div class="form-section-referral">
...
<button type="submit"  class="btn btn-lg btn-info success m-3">Send to client</button>
</div>                
