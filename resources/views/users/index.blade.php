...
<tr class="m-3">
    ...
    <td><a href="{{ route('users.show',$user->id) }}" class="" title="Open" alt="open"><svg xmlns="http://www.w3.org/2000/svg" class="bi bi-file-earmark-plus-fill" viewBox="0 0 16 16" width="24" height="24" fill="#0dcaf0">
