...
class ApplicationLink extends Notification /* implements ShouldQueue*/
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->subject('Application form sent to client from' . ' ' . $referrer)
                    ->line('An application form has been sent to a prospective client from referrer ' . $referrer .'.')
                    ->line('Client - '. $applicantFirstName . ' ' . $applicantLastName)
