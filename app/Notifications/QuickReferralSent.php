...
class QuickReferralSent extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail($notifiable)
    {
        ...
        return (new MailMessage)
                    ->line('A quick referral Application link has been sent to your client:')
                    ->line('**' . $applicantFirstName . ' ' . $applicantLastName . '**')
                    ->line('We will notify you when they complete their application. In the meantime you can login 
